...
// ------------------------------------------------------------------------------------------------
func(f*BlenderTessellatorP2T)Tessellate( polyLoop[]* MLoop ,  vertexCount int, vertices[]*MVert ){
...
// ------------------------------------------------------------------------------------------------
func(f*BlenderTessellatorP2T)AssertVertexCount(  vertexCount int ) {
if ( vertexCount <= 4 ) {
...
// ------------------------------------------------------------------------------------------------
func(f*BlenderTessellatorP2T)Copy3DVertices( polyLoop[]* MLoop ,  vertexCount int,  vertices []*MVert, points []*PointP2T ){
