...
const (
	 ...
	 * hard work for you :)
	 */
	AiProcess_PopulateArmatureData AiPostProcessSteps = 0x4000
...
type PostProcessing interface {
	IsActive(pFlags int) bool
	Execute(pScene *core.AiScene)
	SetupProperties(ctx context.Context)
}

var (
	_ PostProcessing = (*BasePostProcessing)(nil)
)

type BasePostProcessing struct {
}

func (b BasePostProcessing) IsActive(pFlags int) bool {
	return false
}

func (b BasePostProcessing) Execute(pScene *core.AiScene) {

}

func (b BasePostProcessing) SetupProperties(ctx context.Context) {
